...
namespace HelloWorld
{
    ...
    /// </summary>
    public sealed partial class CustomTagging : Page
    {
        ...
        private async void btnSend_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            //POST Data
            postData = "[{\"key\": \"sh_cuid\",  \"string\": \"support@streethawk.com\"}]";


            // HTTP web request
            var httpWebRequest = (HttpWebRequest)WebRequest.Create(App.StreetHawkUrl + "/v2/events/tag");
            ...
            httpWebRequest.Headers["X-Auth-Token"] = App.StreetHawkAuthToken;
